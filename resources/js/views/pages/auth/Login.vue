      ...
      <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
        <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
          ...
          <div>
            ...
            <Password id="password1" v-model="password" placeholder="Password" class="w-full mb-3" inputClass="w-full" inputStyle="padding:1rem" toggleMask></Password>
            ...
            <div class="flex align-items-center justify-content-between mb-5 gap-5">
              ...
              <RouterLink to="/forgotpassword"><a class="font-medium no-underline ml-2 text-right cursor-pointer" style="color: var(--primary-color)">Bạn quên mật khẩu ?</a></RouterLink>

            </div>
            <Button label="Đăng nhập" class="w-full p-3 text-xl"></Button>
